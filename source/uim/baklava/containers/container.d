...
class DBKLContainer { // implements ArrayAccess, ContainerContract
    ...
    protected string[] methodBindings;

    // The container's shared instances.
    protected string[] _instances;

    // The container's scoped instances.
    protected string[] scopedInstances;

    // 
    protected string _aliases;

    // The registered aliases keyed by the abstract name.
    protected string[] _abstractAliases;

    // The extension closures for services.
    protected string[] _extenders;

    // All of the registered tags.
    protected string[] _tags;

    // The stack of concretions currently being built.
    protected string[] _buildStack;

    // The parameter override stack.
    protected string[] with_;

    // The contextual binding map.
    public string[] _contextual;

    // All of the registered rebound callbacks.
    protected string[] _reboundCallbacks;

    // All of the global before resolving callbacks.
    protected string[] _globalBeforeResolvingCallbacks;

    // All of the global resolving callbacks.
    protected string[] globalResolvingCallbacks;

    // All of the global after resolving callbacks.
    protected string[] _globalAfterResolvingCallbacks;

    // All of the before resolving callbacks by class type.
    protected string[] _beforeResolvingCallbacks;

    // All of the resolving callbacks by class type.
    protected string[] _resolvingCallbacks;
...
/*         if (! $concrete instanceof Closure) {
            ...
            $concrete = $this.getClosure(string abstract_, $concrete);
        }
 ...
 */ 
     ...
     * @return \Closure
     * /
    protected function getClosure(string abstract_, $concrete)
    {
        return function ($container, $parameters = []) use (string abstract_, $concrete) {
     ...
     * @return void
     * /
    public function bindIf(string abstract_, $concrete = null, $shared = false)
    {
        if (! $this.bound($abstract)) {
            $this.bind(string abstract_, $concrete, $shared);
        }
    }
     ...
     * @return void
     * /
    public function singleton(string abstract_, $concrete = null)
    {
        $this.bind(string abstract_, $concrete, true);
    }
     ...
     * @return void
     * /
    public function singletonIf(string abstract_, $concrete = null)
    {
        if (! $this.bound($abstract)) {
...
/*     protected function resolve(string abstract_, $parameters = [], $raiseEvents = true)
    {
        ...
        if ($raiseEvents) {
            $this.fireBeforeResolvingCallbacks(string abstract_, $parameters);
        }
 ...
 */
   ...
   /*  public function beforeResolving(string abstract_, Closure $callback = null)
     ...
     * @return void
     */
    /* public function resolving(string abstract_, Closure $callback = null)
    {
        if (is_string($abstract)) {
            $abstract = $this.getAlias($abstract);
        }
     ...
     * @return void
     */
    /* public function afterResolving(string abstract_, Closure $callback = null)
    {
        if (is_string($abstract)) {
            $abstract = $this.getAlias($abstract);
        }
     ...
     * @return void
     */
    /* protected function fireBeforeResolvingCallbacks(string abstract_, $parameters = [])
    {
        $this.fireBeforeCallbackArray(string abstract_, $parameters, $this.globalBeforeResolvingCallbacks);

        foreach ($this.beforeResolvingCallbacks as $type => $callbacks) {
            if ($type === $abstract || is_subclass_of(string abstract_, $type)) {
                $this.fireBeforeCallbackArray(string abstract_, $parameters, $callbacks);
            }
        }
    } */
 ...
 */
     ...
     * @return void
     */
    /* protected function fireResolvingCallbacks(string abstract_, $object)
    {
        $this.fireCallbackArray($object, $this.globalResolvingCallbacks);

        $this.fireCallbackArray(
            $object, $this.getCallbacksForType(string abstract_, $object, $this.resolvingCallbacks)
        );

        $this.fireAfterResolvingCallbacks(string abstract_, $object);
    }
 */
    /**
   ...
   /*  protected function fireAfterResolvingCallbacks(string abstract_, $object)
    {
        ...
        $this.fireCallbackArray(
            $object, $this.getCallbacksForType(string abstract_, $object, $this.afterResolvingCallbacks)
        );
    } */
     ...
     * @return array
     */
    /* protected function getCallbacksForType(string abstract_, $object, array $callbacksPerType)
    {
        $results = [];
